...
PATH_to_relative_R_WD=./allele-specific-gene/graph_snp_only/BM7  ##need to be modified
...
hisat2 -p 30 -t -x ${hisat2_index[3]} -1 ${rnaseq_em_fp_R1} -2 ${rnaseq_em_fp_R2} | samtools view -Sbq 30 > graph.BM-${DAP}DAP.q30.bam && echo "----hisat2 done----"
